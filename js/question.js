const quiz = [
    ...
    answer: 2// timeout before a callback is called
    ...
    {
    tip: ['frontend', 'javascript'],
    q: 'Mi nem igaz a nyílfüggvényre (arrow function)?',
    options: ['<code>=></code> jelet írunk a paraméter(ek) után', 'elhagyjuk a function kulcsszót', 'elhagyjuk a return kulcsszót', 'elhagyjuk a paraméterek körüli zárójeleket'],
    answer: 3,
    expl: ''
    },
    {
