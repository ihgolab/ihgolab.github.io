const quiz = [
  ...
  },
  {
    ...
    options: [
      ...
      "alacsony költségű",
      "egyszerű feladatok elvégzésére tökéletes",
      "nagyon biztonságos",
    ],
    answer: 3,
  },
  ...
  },
  {
    ...
    options: [
      "személyes mappa",
      "a merevlemez egy elkülönített része",
  ...
  },
  {
    ...
    options: [
      "akkor van rá szükség, ha elfogyott a RAM",
      "mérete automatikusan kerül beállításra",
      "a merevlemez egy elkülönített részén vagy SSD-n helyezkedik el",
      "a gyakran használni kívánt adatok átmeneti tárolója",
    ],
    answer: 3,
  },
  {
    ...
    options: [
      "az <kbd>alt</kbd>+<kbd>enter</kbd> billentyűvel",
      'a "fel" kurzormozgató billentyűvel',
      "a jobb egérgombbal",
      "a <kbd>tab</kbd> billentyűvel",
    ],
    answer: 2,
  },
  {
  ...
  },
  {
    q: "Mi az intranet?",
    options: [
      "mindenkinek elérhető nyilvános hálózat",
      "a vállalatok belső kommunikációjára létrehozott zárt hálózat",
      "különálló alhálózatokból felépülő hálózat",
      "elosztó hálózat",
    ],
    answer: 1,
  },
  ...
  },
  {
    ...
    options: [
      "Ma már nincs használatban ez a szolgáltatás.",
      "Privát hálózat gépeinek azonosítását végzi.",
      "A hálózaton használt számítógépnevekhez tartozó IP címeket adja meg.",
      "Távoli számítógépre való bejelentkezést hitelesít.",
    ],
    answer: 2,
  },
  {
    ...
    options: [
      "<kbd>alt</kbd>+<kbd>enter</kbd> billentyűvel",
      'a "le" kurzormozgató billentyűvel',
      "a jobb egérgombbal",
      "az <kbd>F7</kbd> billentyűvel",
    ],
    answer: 3,
  },
  {
    ...
    options: [
      ...
      "mindent újraküld, amit a vevő nem tudott venni",
      "kisebb helyigénnyel tárolja az adatokat",
  ...
  },
  {
    ...
    options: [
      "egyszerű szövegszerkesztővel szerkeszthető állomány, parancsok futtatását a tartalom sorról sorra való olvasásával teszi lehetővé",
      "magas szintű programnyelven íródott, gépi kódra fordított Windows operációs rendszeren futtatható állomány",
      "egyszerű felépítésű, maximum 64 KB méretű bináris fájl",
      "folyamatok eredményét, programok működési naplóit tároló állomány",
    ],
    answer: 0,
  },
  {
    ...
    options: [
      "letölt egy távoli tárolót (repository)",
      "letölti a változásokat a szerverről",
      "hozzáadjuk fájlunkat a <code>staging area</code>-hoz",
      "törli a változtatásokat",
    ],
    answer: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      "lehetőség van a szerveren történt módosításokat áttekinteni, de nem „nyúl hozzá” az aktuális munkánkhoz",
      "letölti a változásokat a szerverről, és integrálja a saját munkánkba",
      "letölt egy távoli repositoryt",
      "a paranccsal hozzáadjuk fájlunkat a <code>staging area</code>-hoz",
    ],
    answer: 0,
    expl: "",
  },
  {
    ...
    options: [
      "a Git követi a fájlt, és mi módosítottuk",
      "a Git követi a fájlt, de mi nem módosítottuk azt",
      "a Git követi a fájlt, ha módosítottuk, a módosítás be fog kerülni az adatbázisba",
      "a Git nem követi a fájlt",
    ],
    answer: 1,
    expl: "",
  },
  ...
  },
  {
    ...
    options: [
      '&lt;a target="https://www.w3.org/"&gt;w3.org&lt;/a&gt;',
      '&lt;link href="https://www.w3.org/"&gt;w3.org&lt;/a&gt;',
      '&lt;a src="https://www.w3.org/"&gt;w3.org&lt;/a&gt;',
  ...
  },
  {
    ...
    options: [
      '&lt;img source="/img/panda.jpg"&gt;',
      '&lt;img src="/img/panda.jpg"&gt;&lt;/img&gt;',
      '&lt;img alt="happy panda" href="/img/panda.jpg"&gt;',
      '&lt;img alt="happy panda" src="/img/panda.jpg"&gt;',
    ],
    answer: 3,
  },
  {
  ...
  },
  {
    ...
    options: [
      "Szövegrészek elrejtésére",
      "Szövegrészek blokkszintűvé tételéhez",
      "Szövegrészek kiemelésére",
      "Szövegrészek nagyobb méretű megjelenítéséhez",
    ],
    answer: 2,
  },
  {
  ...
  },
  {
    ...
    options: [
      "<code>col-*, col-sm-*, col-md-*, col-lg-*, col-xl-*</code>",
      "<code>col-xl-*, col-lg-*, col-md-*, col—sm-*, col-*</code>",
      "<code>col-*, col-md-*, col-sm-*, col-lg-*, col-xl-*</code>",
      "<code>col-lg-*, col-sm-*, col-md-*, col-xl-*</code>",
    ],
    answer: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      'let name : "Béla"; name : "Ödön";',
      'var name : "Béla"; name : "Ödön";',
      'name : "Béla"; name : "Ödön";',
      'const name : "Béla"; name : "Ödön";',
    ],
    answer: 3,
  },
  {
...

  {
    ...
    options: [
      "csak ha blokkhatókörű",
      "igen",
      "csak ha függvényhatókörű",
      "nem",
    ],
    answer: 3,
  },
  ...
  },
  {
    ...
    options: [
      ...
      "Az objektum értéke kerül átadásra",
      "Nem lehet objektumot paraméterként átadni",
      "Az objektum referenciája kerül átadásra",
    ],
    answer: 3,
  },
  {
  ...
  },
  {
    ...
    options: [
      "<code>for (let i = 0; i < count(x); i++) {...}</code>",
      "<code>for (let i = 0; i < a.length; i++) {...}</code>",
      "<code>for (let i = 0; i < a.length;) {...}</code>",
  ...
  },
  {
    ...
    options: [
      "<code>Element.hi.prototype = function() {...}</code>",
      "<code>Element.hi = function() {...}</code>",
      "<code>Element.prototype.hi = function() {...}</code>",
  ...
  },
  {
    ...
    options: [
      ...
      "a művelet még fut",
      "az aszinkron hívás megtörtént, függetlenül a sikerességtől",
    ],
    answer: 2,
    expl: "",
  },
  ...
  },
  {
    ...
    options: [
      'querySelectorAll("img[src$=jpg]")',
      'querySelectorAll("img[href$=jpg]")',
      'querySelectorAll("img[link$=jpg]")',
      'querySelectorAll("img[url$=jpg]")',
    ],
    answer: 0,
    expl: "",
  },
  ...
  },
  {
    ...
    options: [
      "a logikai (boolean) adattípust",
      "az objektum adattípust",
      "a szám adattípust",
      "a sztring adattípust",
    ],
    answer: 1,
  ...
  },
  {
    ...
    options: [
      "<code>let 10legjobbAjanlat</code>",
      "<code>let var$</code>",
      "<code>let _myVar</code>",
      "<code>let kerdesSzam50</code>",
    ],
    answer: 0,
  ...
  },
  {
    ...
    options: [
      "tömbbel és objektummal is működik",
      "nem kell ciklusváltozót inicializálni",
      "a <code>for</code> ciklusnál egyszerűbb a szintaxisa",
      "az objektum vagy tömb értékeit járja be",
    ],
    answer: 3,
    expl: "",
  },
  ...
  },
  {
    ...
    options: [
      "lehetőség van a szerveren történt módosításokat áttekinteni, de nem „nyúl hozzá” az aktuális munkánkhoz",
      "letölti a változásokat a szerverről, és integrálja a saját munkánkba",
      "feltölti fájljainkat a szerverre, amikre kiadtuk a commit parancsot",
      "a paranccsal hozzáadjuk fájlunkat a <code>staging area</code>-hoz",
    ],
    answer: 2,
    expl: "",
  ...
  },
  {
    ...
    options: [
      "sztring1.concat(sztring2);",
      "sztring1.match(sztring2);",
      "sztring1.substring(sztring2);",
      "sztring1.replace(sztring2);",
    ],
    answer: 0,
    expl: "",
  },
  ...
  },
  {
    ...
    options: [
      ...
      '&lt;style href="alap.css" rel="stylesheet"&gt;',
      '&lt;meta href="alap.css" rel="stylesheet"&gt;',
      '&lt;source href="alap.css" rel="stylesheet"&gt;',
    ],
    answer: 0,
    expl: "",
  },
